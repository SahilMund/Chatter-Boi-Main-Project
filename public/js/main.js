...
const chatside = document.getElementsByClassName('chat-sidebar')[0];
const chatMessages = document.querySelector('.chat-messages');

const videocall = document.querySelector('.fs');


toggle.addEventListener('click',()=>{
  console.log(chatside.style.display);
  if( chatside.style.display== 'inherit'){
    chatside.style.display= 'none'
  }else{
    chatside.style.display= 'inherit'
  }
})
